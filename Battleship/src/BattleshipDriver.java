...
public class BattleshipDriver extends Canvas implements MouseListener
{
    ...
    private int countRounds1 = 0;

    public BattleshipDriver()
    {
        battleship = new Battleship();
        battleship.addPlayer(new ComputerPlayer("Mr. Hubbard"));
        battleship.addPlayer(new EvanSeeyave("AlphaBattleship"));
    ...
    private void render()
    {
        ...
        {
            System.out.println("Rounds: " + countRounds1);
            // End Screen
    ...
    public void mouseClicked(MouseEvent e)
    {
        ...
        if(r > y && r < y + len && c > x && c < x + len)    // clicked on board
        {
            ...
            System.out.println("Rounds: " + countRounds);
        }
